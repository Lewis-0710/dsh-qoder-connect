 ...
 */
export const PROBE_EFFORT_CANDIDATES: readonly QoderEffort[] = ['low', 'medium', 'high', 'xhigh', 'max']
...
export type ProbeOutcome =
  | { validation: 'validating'; efforts: readonly QoderEffort[]; requests: number }
