...
- **每日自动签到与日志明细**：支持每天 10:00 (UTC+8) 自动签到领取 100 Credits 算力额度，配备双端开关与开机防漏补签机制；卡片常驻「签到日志」面板，提供执行流水记录与「立即签到」、「刷新」、「清空日志」快捷操作。
...
支持在设置卡片中开启每日自动签到，并在卡片底部的「签到日志」面板中查看签到流水、立即签到或清空日志：
