	...
	ctx.inject(["settings"], (settingsCtx) => {
		...
		*/
		...
		const registerNs = (ns, schema) => {
			if (typeof settingsService.installSection === "function") try {
			...
			if (typeof settingsService.register === "function") try {
