window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function ModelSwitchTable({ models, disabledModels = [], t, disabled, onSetModelsEnabled }) {
			const [selected, setSelected] = (0, react.useState)(/* @__PURE__ */ new Set());
			const [searchQuery, setSearchQuery] = (0, react.useState)("");
			const disabledSet = (0, react.useMemo)(() => new Set(disabledModels), [disabledModels]);
			const list = (0, react.useMemo)(() => models ?? [], [models]);
			const filteredList = (0, react.useMemo)(() => {
			...
			const handleBatch = (enabled) => {
				const targets = Array.from(selected);
				if (targets.length === 0) return;
				onSetModelsEnabled(targets, enabled);
				setSelected(/* @__PURE__ */ new Set());
			};
			if (list.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: quotaListStyle,
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: allFilteredSelected ? t("modelsDeselectAll") : t("modelsSelectAll") })]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								alignItems: "center",
							...
							children: [
								selected.size > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: modelRateStyle,
									children: t("modelsSelectedCount", { count: selected.size })
								}) : null,
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: buttonStyle$1,
									...
									children: t("modelsEnableSelected")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: buttonStyle$1,
									...
									children: t("modelsDisableSelected")
								})
							]
						})]
					}),
					filteredList.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: descriptionStyle,
						children: t("modelsNoMatch", { query: searchQuery.trim() })
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							display: "flex",
							flexDirection: "column",
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											style: {
												fontSize: 12,
												color: isModelEnabled ? "var(--dsw-alias-label-primary)" : "var(--dsw-alias-label-tertiary)"
											},
											children: isModelEnabled ? t("modelsEnabled") : t("modelsDisabled")
										})]
									})
								})]
							}, model.id);
					...
					children: [
						...
						status?.status === "signed-in" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							tab === "status" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								style: tabPanelStyle,
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelSwitchTable, {
									models: status.models,
								...
								children: status.credits === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									}), status.credits.accounts.filter((account) => account.remain > 0 || account.unlimited === true).map((account, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CreditBar, {
		...
		*/
		function PluginSettingsSection(props) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
				...
				children: props.renderSlot(SHARED_ITEM_SLOT, {})
			});
		}
		/**
		...
		function apply(ctx) {
			try {
				...
				*/
				...
				const registerUnifiedCard = (slot) => {
					const inject = () => ({
						t,
						scope: quotaScope,
				...
				*/
				const joinSharedSettingsBlock = () => {
					ctx.slots.inject(SHARED_SECTION_SLOT, () => {
						...
						if (!ctx.slots.entries(SHARED_SECTION_SLOT).some((entry) => entry.options?.id === SHARED_SECTION_ID)) try {
