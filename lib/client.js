	...
	factory: (require) => {
		...
		*/
		...
		function CheckInLogTable({ logs = [], t }) {
			if (!logs || logs.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						status?.status === "signed-in" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							(() => {
								const availableTabs = status?.status === "signed-in" && (status.checkIn?.logs?.length ?? 0) > 0 ? [
									"status",
									"context",
									"details",
									"checkin"
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									role: "tablist",
									style: tabBarStyle,
									children: availableTabs.map((id) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										role: "tab",
