window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const QODER_CARD_VARIANTS = [QODER_CN_CARD, {
			id: "qoder-global",
			titleKey: "titleAI",
			introKey: "introAI",
		...
		const cardHoverStyle$1 = { borderColor: "var(--dsw-alias-label-dimmed)" };
		/** Expanded, matching the built-in card's open state. */
		const cardOpenStyle$1 = {
		...
		*/
		const headerFocusStyle$1 = {
			outline: "2px solid var(--dsw-alias-brand-primary)",
			outlineOffset: -2
		};
		const headTextStyle$1 = {
			display: "flex",
			flex: 1,
			minWidth: 0,
		...
		*/
		...
		function QoderPluginCard({ t, variant = QODER_CN_CARD }) {
			...
			*/
			...
			const patEntry = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: bodyStyle,
						children: t(variant.patGuideKey)
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: patRowStyle,
						children: [
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				style: {
					...cardStyle$1,
					...hovered ? cardHoverStyle$1 : {},
					...open ? cardOpenStyle$1 : {}
				},
				onMouseEnter: () => {
					setHovered(true);
				},
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					style: {
						...headerStyle,
						...headerFocused ? headerFocusStyle$1 : {}
					},
					"aria-expanded": open,
		...
		*/
		...
		function stableProject(scope) {
			...
			if (scope !== cachedScope || source !== cachedSource || cachedProjection === void 0) {
				cachedScope = scope;
				cachedSource = source;
		...
		function QuotaSettingsCard(props) {
			...
			const projection = (0, react.useSyncExternalStore)(scope?.subscribe.bind(scope) ?? ((listener) => listener), () => stableProject(scope));
			const [open, setOpen] = (0, react.useState)(false);
			const [hovered, setHovered] = (0, react.useState)(false);
			const [headerFocused, setHeaderFocused] = (0, react.useState)(false);
			...
			const signed = {
				...
				global: probe?.global ?? reported.global
			};
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: titleStyle,
							children: t("quotaSettingsTitle")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: introStyle,
							children: t("quotaSettingsIntro")
						})]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: {
							...chevronStyle,
		...
		function apply(ctx) {
			try {
				...
				ctx.slots.inject("settings.plugin.item", () => ctx.slots.register({
					...
					priority: 50,
					inject: () => ({
						...quotaSettingsInjected,
						scope: quotaScope
					})
				}, QuotaSettingsCard));
				for (const [index, variant] of QODER_CARD_VARIANTS.entries()) ctx.slots.inject("settings.plugin.item", () => ctx.slots.register({
					name: "settings.plugin.item",
					key: variant.id,
